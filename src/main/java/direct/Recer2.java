...
public class Recer2 {
    public static void main(String[] args) throws Exception {
        ...
        //绑定路由（关注）表示将test_exchange_direct_queue2绑定到test_exchange_direct路由上并设置select操作（路由键操作）全部交给test_exchange_direct_queue2来处理
        ...
        //4.监听队列 true:自动消息确认
        channel.basicConsume("test_exchange_direct_queue2", true, consumer);
    }
}
